...
namespace hwj.DBUtility.MYSQL
{
    ...
    public abstract class DbHelperMySQL
    {
        ...
        /// <param name="SQLString">SQL语句</param>
        /// <returns>影响的记录数</returns>
        public static int ExecuteSql(string SQLString, List<MySqlParameter> cmdParms)
        {
            using (MySqlConnection connection = new MySqlConnection(ConnectionString))
            {
        ...
        /// <param name="strSQL">查询语句</param>
        /// <returns>MySqlDataReader</returns>
        public static MySqlDataReader ExecuteReader(string SQLString, List<MySqlParameter> cmdParms)
        {
            MySqlConnection connection = new MySqlConnection(ConnectionString);
            MySqlCommand cmd = new MySqlCommand();
            try
        ...
        private static void PrepareCommand(MySqlCommand cmd, MySqlConnection conn, MySqlTransaction trans, string cmdText, List<MySqlParameter> cmdParms)
        {
