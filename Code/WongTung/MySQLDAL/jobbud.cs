...
namespace WongTung.MySQLDAL
{
	...
	public class jobbud:Ijobbud
	{
		...
		public bool Exists(string JOB_CO_CODE,string JOB_CODE,string JOB_SER,string JOB_POS)
		{
			...
			strSql.Append("select count(1) from jobbud");
			strSql.Append(" where JOB_CO_CODE=@JOB_CO_CODE and JOB_CODE=@JOB_CODE and JOB_SER=@JOB_SER and JOB_POS=@JOB_POS ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into jobbud(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update jobbud set ");
			strSql.Append("JOB_STAFF=@JOB_STAFF,");
		...
		public WongTung.Model.jobbud GetModel(string JOB_CO_CODE,string JOB_CODE,string JOB_SER,string JOB_POS)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select JOB_CO_CODE,JOB_CODE,JOB_SER,JOB_POS,JOB_STAFF,JOB_BUD,JOB_NOR,JOB_NOR_EXP,JOB_OT,JOB_OT_EXP from jobbud ");
			strSql.Append(" where JOB_CO_CODE=@JOB_CO_CODE and JOB_CODE=@JOB_CODE and JOB_SER=@JOB_SER and JOB_POS=@JOB_POS ");
			MySqlParameter[] parameters = {
					new MySqlParameter("@JOB_CO_CODE", MySqlDbType.Char,50),
					new MySqlParameter("@JOB_CODE", MySqlDbType.Char,50),
