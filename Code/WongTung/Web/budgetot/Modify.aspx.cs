...
namespace WongTung.Web.budgetot
{
	...
	private void ShowInfo()
	{
		...
		this.txtBG_CO_CODE.Text=model.BG_CO_CODE;
		this.txtBG_JOB_CODE.Text=model.BG_JOB_CODE;
		this.txtBG_SER_CODE.Text=model.BG_SER_CODE;
		this.txtBG_POS.Text=model.BG_POS;
		this.txtBG_HOUR.Text=model.BG_HOUR.ToString();
		this.txtBG_EXP_BUDGET.Text=model.BG_EXP_BUDGET.ToString();
