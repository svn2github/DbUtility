...
namespace WongTung.Web.outstanding_temp
{
	...
	private void ShowInfo(decimal NUM)
	{
		...
		this.txtOUT_OFF_CODE.Text=model.OUT_OFF_CODE;
		this.txtOUT_OFF_NAME.Text=model.OUT_OFF_NAME;
		this.txtOUT_EMP_CODE.Text=model.OUT_EMP_CODE;
		this.txtOUT_EMP_NAME.Text=model.OUT_EMP_NAME;
		this.txtOUT_DAY.Text=model.OUT_DAY.ToString();
		this.txtOUT_POS_CLASS.Text=model.OUT_POS_CLASS.ToString();
		this.txtOUT_POS_CODE.Text=model.OUT_POS_CODE;
		this.txtOUT_UPDATE_DATE.Text=model.OUT_UPDATE_DATE.ToString();
