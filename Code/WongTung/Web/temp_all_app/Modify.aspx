<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="WongTung.Web.temp_all_app.Modify" Title="修改页" %>
...
<table cellSpacing="0" cellPadding="0" width="100%" border="0">
	...
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtTEM_BF_SUM" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		TEM_NOR_HOUR_0
	...
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtTEM_QUE" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		TEM_POS_CODE
	...
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtTEM_POS_CODE" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
