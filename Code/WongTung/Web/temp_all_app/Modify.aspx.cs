...
namespace WongTung.Web.temp_all_app
{
	...
	private void ShowInfo()
	{
		...
		WongTung.Model.temp_all_app model=bll.GetModel();
		...
		this.txtTEM_BF_SUM.Text=model.TEM_BF_SUM.ToString();
		...
		this.txtTEM_QUE.Text=model.TEM_QUE;
		this.txtTEM_POS_CODE.Text=model.TEM_POS_CODE;
