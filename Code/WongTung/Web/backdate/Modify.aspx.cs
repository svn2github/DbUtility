...
namespace WongTung.Web.backdate
{
	...
	private void ShowInfo()
	{
		...
		this.txtBK_CO_CODE.Text=model.BK_CO_CODE;
		this.txtBK_USER.Text=model.BK_USER;
		this.txtBK_RAN_NO.Text=model.BK_RAN_NO;
		this.txtBK_EMP.Text=model.BK_EMP;
		this.txtBK_RAN_DATE.Text=model.BK_RAN_DATE.ToString();
		this.txtBK_CRE_DATE.Text=model.BK_CRE_DATE.ToString();
		this.txtBK_STATUS.Text=model.BK_STATUS;
