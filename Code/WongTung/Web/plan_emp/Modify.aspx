<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="WongTung.Web.plan_emp.Modify" Title="修改页" %>
...
<table cellSpacing="0" cellPadding="0" width="100%" border="0">
	...
	<td height="25" width="*" align="left">
		<asp:label id="lblPLA_EMP_CO" runat="server"></asp:label>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		PLA_EMP_OFF
	...
	<td height="25" width="*" align="left">
		<asp:label id="lblPLA_EMP_OFF" runat="server"></asp:label>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		PLA_EMP_POS
	...
	<td height="25" width="*" align="left">
		<asp:label id="lblPLA_EMP_POS" runat="server"></asp:label>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		PLA_EMP_CODE
	...
	<td height="25" width="*" align="left">
		<asp:label id="lblPLA_EMP_CODE" runat="server"></asp:label>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		PLA_EMP_NUM
