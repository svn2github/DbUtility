...
namespace WongTung.Web.pat_job_tem
{
	...
	private void ShowInfo(string AJ_CO_CODE,string AJ_EMP_CODE)
	{
		...
		this.lblAJ_CO_CODE.Text=model.AJ_CO_CODE;
		this.lblAJ_EMP_CODE.Text=model.AJ_EMP_CODE;
		this.txtAJ_LAST_DATE.Text=model.AJ_LAST_DATE.ToString();
		this.txtAJ_LAST_NUM.Text=model.AJ_LAST_NUM.ToString();
		this.txtAJ_JOB_1.Text=model.AJ_JOB_1;
		this.txtAJ_JOB_2.Text=model.AJ_JOB_2;
		this.txtAJ_JOB_3.Text=model.AJ_JOB_3;
		this.txtAJ_JOB_4.Text=model.AJ_JOB_4;
		this.txtAJ_JOB_5.Text=model.AJ_JOB_5;
		this.txtAJ_JOB_6.Text=model.AJ_JOB_6;
		this.txtAJ_JOB_7.Text=model.AJ_JOB_7;
		this.txtAJ_JOB_8.Text=model.AJ_JOB_8;
		this.txtAJ_JOB_9.Text=model.AJ_JOB_9;
		this.txtAJ_JOB_10.Text=model.AJ_JOB_10;
		this.txtAJ_JOB_11.Text=model.AJ_JOB_11;
		this.txtAJ_JOB_12.Text=model.AJ_JOB_12;
		this.txtAJ_JOB_13.Text=model.AJ_JOB_13;
		this.txtAJ_JOB_14.Text=model.AJ_JOB_14;
		this.txtAJ_JOB_15.Text=model.AJ_JOB_15;
		this.txtAJ_JOB_16.Text=model.AJ_JOB_16;
		this.txtAJ_JOB_17.Text=model.AJ_JOB_17;
		this.txtAJ_JOB_18.Text=model.AJ_JOB_18;
		this.txtAJ_JOB_19.Text=model.AJ_JOB_19;
		this.txtAJ_JOB_20.Text=model.AJ_JOB_20;
